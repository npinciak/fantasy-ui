import { LineupEntityMap } from '../../models/espn-client.model';
import { FootballLineupSlot } from './lineup.model';

export const FOOTBALL_LINEUP_MAP: LineupEntityMap = {
  0: {
    abbrev: 'QB',
    active: true,
    bench: false,
...
export const FOOTBALL_LINEUP_SLOT_LIST = [
  ...
  FootballLineupSlot.TQB,
  FootballLineupSlot.RB,
  FootballLineupSlot.RBORWR,
  FootballLineupSlot.WR,
  FootballLineupSlot.WRORTE,
  FootballLineupSlot.TE,
  FootballLineupSlot.OP,
  FootballLineupSlot.DT,
  FootballLineupSlot.DE,
  FootballLineupSlot.LB,
  FootballLineupSlot.DL,
  FootballLineupSlot.CB,
  FootballLineupSlot.S,
  FootballLineupSlot.DB,
  FootballLineupSlot.DP,
  FootballLineupSlot.DST,
  FootballLineupSlot.K,
  FootballLineupSlot.P,
  FootballLineupSlot.HC,
  FootballLineupSlot.BE,
  FootballLineupSlot.IR,
  FootballLineupSlot.INV,
  FootballLineupSlot.FLEX,
  FootballLineupSlot.EDR,
  FootballLineupSlot.ALL,
] as const;

export const BASIC_FOOTBALL_LINEUP_SLOT_LIST: FootballLineupSlot[] = [
  FootballLineupSlot.QB,
  FootballLineupSlot.RB,
  FootballLineupSlot.WR,
  FootballLineupSlot.FLEX,
