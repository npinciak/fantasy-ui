...
import { MockGame, MockLeague, MockTeam, MockTransaction } from '@app/modules/espn/models/mlb/mocks';
...
const MOCK_DATA = {
    ...
    CLIMACELL_REQUEST: 'https://api.tomorrow.io/v4/timelines?fields=pressureSeaLevel,precipitationIntensity,precipitationType,precipitationProbability,temperatureApparent,temperature,humidity,dewPoint,windSpeed,windGust,windDirection,weatherCode&timesteps=current&units=imperial&timezone=est&location=40.7128,74.0060',
    LEAGUE_ID: 8675309,
    // eslint-disable-next-line max-len
