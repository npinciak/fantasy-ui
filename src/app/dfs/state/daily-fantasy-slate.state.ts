...
import { FetchSlates, SetSlates } from '../actions/daily-fantasy-slates.actions';
...
@Injectable()
export class DailyFantasySlateState extends GenericState({ idProperty: 'importId', addOrUpdate: SetSlates }) {
