...
export class TeamComponent implements OnInit {
  ...
  get batterLineup() {
    return this._batters.sort((a, b) => a.lineupSlot.displayOrder - b.lineupSlot.displayOrder).filter(player => !player.lineupSlot.bench);
  }
  ...
  get pitcherLineup() {
    return this._pitchers.sort((a, b) => a.lineupSlot.displayOrder - b.lineupSlot.displayOrder).filter(player => !player.lineupSlot.bench);
  }
  ...
  private get _roster() {
    return new Map(); // rosterMap(this._team.roster);
  }
  ...
  private get _team() {
    return this.mlbFacade.selectTeamById(this.teamId);
  }
