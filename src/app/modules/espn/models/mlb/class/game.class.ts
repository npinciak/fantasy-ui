...
import { logoBuilder } from '../helpers';
...
export class Game {
  ...
  get homeTeam(): ScoreboardGameTeam {
    return {
      ...
      logo: logoBuilder('mlb', mlbTeamMap[this._homeTeam]),
      isWinner:
        this._competitors.get(this._homeTeam).winner ||
        this._competitors.get(this._homeTeam).score >
          this._competitors.get(this._awayTeam).score,
    };
  }
  ...
  get awayTeam(): ScoreboardGameTeam {
    return {
      ...
      logo: logoBuilder('mlb', mlbTeamMap[this._awayTeam]),
      isWinner:
  ...
  get location(): ScoreboardGameLocation {
    return {
      ...
      latLng: `${MLB_STADIUM_MAP[this._homeTeam].lat}, ${
